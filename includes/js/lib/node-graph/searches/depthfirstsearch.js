 ...
 * and interesting data about the vertices traversed in the graph.
 *
 * @param  Object An object containing a list of vertices.
 */
var DepthFirstSearch = function(vertices, root) {
	...
	if (root === undefined) {
    	...
    	self.spanningTree[root] = null;
        self.search(vertices[root.label]);
    }
